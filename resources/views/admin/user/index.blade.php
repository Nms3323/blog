	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-fluid d-flex flex-end ml-auto mr-auto">
			...
			<div class="d-flex align-items-center py-1">
				...
				<!--end::Wrapper-->
				<!--begin::Button-->
				<a href="{{route('admin.user.create')}}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create</a>
				<!--end::Button-->
			</div>
			<!--end::Actions-->
		</div>
						...
						<table class="table align-middle table-row-dashed fs-6 gy-5 data-table dataTableNew" id="kt_subscriptions_table user_list">
							...
							<tbody class="text-gray-600 fw-bold">
								...
								<tr>
									...
									<td>
										<a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit" href="{{route('admin.user.edit', $dt->id)}}" style="background: #968cbd;">
											<i class="la la-edit" style="color: white !important;"></i>
										</a>
										<input type="hidden" value="{{ $dt->id }}" name="delete_user_id" id="delete_user_id">
										<button class="btn btn-sm btn-clean btn-icon btn-icon-md" id="delete_user" style="background-color: red;" data-toggle="tooltip" title="Delete">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		{
			var obj = $(this);
			var id = $(this).closest('td').find("#delete_user_id").val();
			var delete_url = "{{route('admin.user.destroy', ':id') }}";
