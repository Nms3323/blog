			...
			<div class="d-flex flex-column flex-xl-row">
				...
				<div class="row">
					<div class="col-md-12 pe-lg-10">
						<!--begin::Form-->
						<form action="{{ route('admin.blog.update',$blog_data->id) }}" method="post" class="form mb-15 add__form" id="kt_contact_form">
							<!--begin::Input group-->
							{{ method_field('PATCH') }}
							@csrf
							<input type="hidden" name="hidden_id" value="{{$blog_data->id}}">
							...
							<div class="row mb-5">
								...
								<div class="col-md-12 fv-row">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" required value="{{$blog_data->name}}" class="form-control form-control-solid" placeholder="Please enter title" id="name" name="name" />
									<!--end::Input-->
								</div>
								<!--end::Col-->
							</div>
							...
							<div class="row mb-5">
								...
								<div class="col-md-12 fv-row">
									...
									<select class="form-control" name="user_id" id="user_id" required>
										...
										@if($user_list_dt->id == $blog_data->user_id)
